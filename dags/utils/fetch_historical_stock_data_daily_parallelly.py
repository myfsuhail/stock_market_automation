...
def load_csv_to_duckdb(n, file_path, duckdb_path='/opt/airflow/stock_automate/buy_sell_buddy.duckdb', table_name='historical_stock_data_daily'):
    try:
        conn = duckdb.connect(duckdb_path)
        df = pd.read_csv(file_path)
...
if __name__ == '__main__':
    ...
    #truncate_table_duckdb('/opt/airflow/stock_automate/buy_sell_buddy.duckdb', 'historical_stock_data_daily')
